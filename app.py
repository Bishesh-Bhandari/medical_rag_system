...
from rag.retriever import get_retreiver
...
def is_greeting(text: str) -> bool:
    ...
    greetings = [
        ...
        "how are you", "how're you", "how r you"
    ]
        ...
        with st.chat_message("assistant"):
            ...
            if is_greeting(user_input):
                greeting_responses = [
                    ...
                    "Hi there! 😊 What medical information can I provide?",
                    "Hey! 👋 Ask me anything about medical topics.",
                ]
                docs = random.choice(greeting_responses)
                st.markdown(docs)
            else:
                with st.spinner("Searching medical knowledge base..."):

                    time.sleep(1.2)
                    docs = chatbot_response(user_input)
